          ...
          <div className="relative bg-white rounded-t-3xl sm:rounded-3xl w-full sm:max-w-lg shadow-2xl animate-slide-up max-h-[90vh] overflow-y-auto">
            ...
            <div className="px-6 sm:px-8 pb-8 pt-4 sm:pt-7">
              ...
              <div className="flex items-start justify-between mb-6">
                <div>
                  <h2 className="font-serif text-2xl sm:text-3xl font-black text-amber-900 leading-tight">
                    Sign the Pie-nup
                  </h2>
                ...
                <button
                  onClick={closeModal}
                  className="ml-4 mt-0.5 text-amber-300 hover:text-amber-500 transition-colors flex-shrink-0"
                  aria-label="Close"
                >
                  <svg
                    className="w-6 h-6"
              ...
              {success ? (
                <div className="text-center py-10">
                  ...
                  <h3 className="font-serif text-2xl font-black text-amber-900">
                    Pie committed!
                  </h3>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {TYPE_OPTIONS.map((opt) => (
                        ...
                        >
                          ...
                          <span
                            className={`text-xs font-bold ${selectedType === opt.value ? "text-amber-800" : "text-amber-500"}`}
                          >
                            {opt.label}
                          </span>
                          <span className="text-[10px] leading-tight text-amber-400 mt-0.5">
                            {opt.desc}
                          </span>
                        </label>
                      ))}
